          ...
          <Container style={styles.container}>
            ...
            <Section style={styles.statsContainer}>
              <div style={styles.stat}>
                ...
                <Text style={styles.heading}>₹{income.toFixed(2)}</Text>
              </div>
              <div style={styles.stat}>
                <Text style={styles.text}>Total Expenses</Text>
                <Text style={styles.heading}>₹{expenses.toFixed(2)}</Text>
              </div>
              <div style={styles.stat}>
            ...
            {data?.insights && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>Income Expense Tracker Insights</Heading>
            ...
            <Text style={styles.footer}>
              Thank you for using Income Expense Tracker. Keep tracking your finances for better
              financial health!
            </Text>
          </Container>
        </Body>
          ...
          <Container style={styles.container}>
            ...
            <Section style={styles.statsContainer}>
              <div style={styles.stat}>
                ...
                <Text style={styles.heading}>₹{budgetAmount.toFixed(2)}</Text>
              </div>
              <div style={styles.stat}>
